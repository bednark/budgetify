...
- **Dashboard** - główny panel, któy prezentuje wizualizacje finansów w formie wykresów. Użytkownik ma możliwość wyboru zakresu dat, dla którego będą prezentowane dane.
- **Wydatki** - sekcja umożliwiająca dodawanie i przeglądanie wydatków.
...
- **MongoDB** - nierelacyjna baza danych wykorzystywana w aplikacji do trwałego przechowywania danych.
...
- **web-push** - biblioteka służąca do wysyłania powiadomień Web Push do przeglądarek internetowych zgodnie ze standardem W3C.
